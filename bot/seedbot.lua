...
!invite @armanturbo
هشدار:درصورت سواستفاده از دستورفوق گروه توقیف⚠️
⚠️می شود
➖➖➖➖➖➖➖➖➖
هرگونه سوال یا مشکل در ربات
را از طریق دستور فیدبک برای مدیران
ربات ارسال و منتظر جواب باشید.
!feedback [متن سوال یا مشکل]
شما ميتوانيد از ! و / استفاده کنيد. 
تنها مديران ميتوانند ربات ادد کنند. 
تنها معاونان و مديران ميتوانند 
